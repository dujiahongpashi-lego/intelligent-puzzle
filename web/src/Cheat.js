...
class App extends React.Component {
  constructor(props) {
    ...
    const block2 = new Block(1, 2, '2')
    const block3 = new Block(1, 3, '3')
    const blocks = [block_G, block_E, block_D, block_C, block_B, block3, block2, block1]
  ...
  cheat() {
    ...
    setTimeout(() => {
      ...
      const block2 = new Block(1, 2, '2')
      const block3 = new Block(1, 3, '3')
      puzzlePlate.putBlock(block1, 2, 3, 1)
      puzzlePlate.putBlock(block2, 0, 6, 1)
      puzzlePlate.putBlock(block3, 5, 7, 1)
  ...
  newPuzzle() {
    ...
    setTimeout(() => {
      ...
      while (!puzzlePlate.putBlocks(that.blocks)) {
        counter++
        puzzlePlate.randomInitAsHFA()
      }
      ...
      that.plate.erasurePlace(0, 0, 8, 8)
      // that.plate.update([1, 2, 3, '1', '2', '3'], puzzlePlate)
      that.plate.update(['H', 'F', 'A'], puzzlePlate)
      that.puzzlePlate = puzzlePlate
      that.setState({ ...that.state, puzzleDone: true })
    }, 10)
